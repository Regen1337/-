...
vgui.Register("CategoryPanel", PANEL, "EditablePanel")
...
vgui.Register("RSegmentedProgress", PANEL, "Panel")
...
vgui.Register("RListRow", PANEL, "Panel")
...
vgui.Register("RCheckBox", PANEL, "EditablePanel")
...
vgui.Register("RNumSlider", PANEL, "Panel")
...
vgui.Register("RSlider", PANEL, "EditablePanel")
...
vgui.Register("RLabel", PANEL, "Panel")
...
vgui.Register("RIconTextEntry", PANEL, "ixTextEntry")
