...
function PANEL:Init()
	...
	local createButton = self.mainButtonList:Add("RMenuButton")
	...
	self.loadButton = self.mainButtonList:Add("RMenuButton")
	self.loadButton:SetText("load")
    self.loadButton:DockMargin(0, 10, 0, 0)
	...
	if (extraURL != "" and extraText != "") then
		...
		local extraButton = self.mainButtonList:Add("RMenuButton")
		extraButton:SetText(extraText, true)
        extraButton:DockMargin(0, 10, 0, 0)
	...
	-- leave/return button
	self.returnButton = self.mainButtonList:Add("RMenuButton")
...
function PANEL:UpdateReturnButton(bValue)
    ...
    self.returnButton:DockMargin(0, 10, 0, 0)
