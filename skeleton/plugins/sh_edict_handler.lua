local PLUGIN = PLUGIN
--[==[    
    You can define variables, functions, and hooks as needed.
    Remember to use Helix API and functions to interact with the Helix framework.
    You can refer to the Helix documentation for more information.
    https://github.com/NebulousCloud/helix/wiki/
]==]
...
do
    function PLUGIN:Cleanup(delay)
        ...
        timer.Simple(delay, function()
            ...
            ix.chat.Send(nil, "server", "Entity cleanup complete! Removed " .. count .. " entities!", true)
